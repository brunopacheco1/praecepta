...
public class BenchmarkEngineTest {
    ...
    private BenchmarkExcelLoader benchmarkExcelLoader;

    @BeforeProperty
    void beforeTry() {
        benchmarkExcelLoader = new BenchmarkExcelLoader("decision_table.xlsx");
        benchmarkEngine = new BenchmarkEngine(benchmarkExcelLoader);
    }
