package com.github.brunopacheco1.praecepta.maven.plugin.templates;
...
import com.github.brunopacheco1.praecepta.maven.plugin.templates.beans.InputBeanModel;
import com.github.brunopacheco1.praecepta.maven.plugin.templates.beans.OutputBeanModel;

import static com.github.brunopacheco1.praecepta.maven.plugin.templates.TemplateConfigurationConst.CONFIGURATION;

public class InputOutputEngineGenerator {

    public static void generateInputOutputBeans(
