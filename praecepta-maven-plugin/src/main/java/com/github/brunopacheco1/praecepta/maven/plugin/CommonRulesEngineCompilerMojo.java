package com.github.brunopacheco1.praecepta.maven.plugin;
...
import com.github.brunopacheco1.praecepta.maven.plugin.beans.LoadingMode;
import com.github.brunopacheco1.praecepta.maven.plugin.rules.PluginExcelLoader;
import com.github.brunopacheco1.praecepta.maven.plugin.rules.PluginRulesEngine;
import com.github.brunopacheco1.praecepta.maven.plugin.templates.InputOutputEngineGenerator;
import com.github.brunopacheco1.praecepta.maven.plugin.templates.compilation.CompiledEngineClassGenerator;
import com.github.brunopacheco1.praecepta.maven.plugin.templates.compilation.InputsConstantGenerator;
import com.github.brunopacheco1.praecepta.maven.plugin.templates.compilation.NodeClassGenerator;
import com.github.brunopacheco1.praecepta.maven.plugin.templates.compilation.OutputsConstantGenerator;
import com.github.brunopacheco1.praecepta.maven.plugin.templates.inmemory.InMemoryEngineGenerator;
import com.github.brunopacheco1.praecepta.maven.plugin.templates.inmemory.InMemoryLoaderClassGenerator;
...
public class CommonRulesEngineCompilerMojo extends AbstractMojo {
    ...
    @Parameter(defaultValue = "com.github.brunopacheco1.praecepta")
